...
path_in = r"C:\Users\njamo\OneDrive\Document\quindata_Gen\synthcity_env\data\input\willow_dataset_complete.xlsx"
path_out = "C:/Users/njamo/OneDrive/Document/quindata_Gen/synthcity_env/data/output/"
...
def evaluate_and_generate(model_name, loader, synthetic_size, model_params=None):
    ...
    if model_params:
        ...
        # NormalizingFlows parameters
        elif model_name == "nflow":
            model_params = {
                "n_iter": model_params.get("n_iter", 1),
                "n_units_hidden": model_params.get("n_units_hidden", 10),
            }

        # rtvae parameters
        elif model_name == "rtvae":
            model_params = {
                "n_iter": model_params.get("n_iter", 1),
                "n_units_embedding": model_params.get("n_units_embedding", 10),
                "decoder_n_units_hidden": model_params.get("decoder_n_units_hidden", 10),
        ...
        # arf parameters
            ...
            model_params = {
                "num_trees": model_params.get("num_trees", 3),
                "max_iters": model_params.get("max_iters", 2),
            }

        # goggle parameters
        elif model_name == "goggle":
            model_params = {
                "n_iter": model_params.get("n_iter", 1),
                "logging_epoch": model_params.get("logging_epoch", 10),
            }
...
if __name__ == "__main__":
    ...
    models = ["ctgan", "tvae", "decaf", "nflow", "rtvae", "arf"]
    # /!\  - "goggle" : Error indicates that goggle does not exit, even if it is on the Lib
    #      - "bayesian_network" : mostly for categorical type of target var.
